                    ...
                    <div class="card alert">
                                ...
                                <ul>
                                    ...
                                    <li class="card-option drop-menu"><i class="ti-settings" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" role="link"></i>
                                        <ul class="card-option-dropdown dropdown-menu">
                                            <li><a href="${pageContext.request.contextPath}/user/toUpdateUser.do?=${param.id}"><i class="ti-loop"></i> 更新日志</a></li>
                        ...
                        <div class="card-body">
                            <div class="horizontal-form-elements">
                                <form:form modelAttribute="user" method="post" action="${pageContext.request.contextPath}/user/updateUser.do" cssClass="form-horizontal">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">游客id</label>
                                                <div class="col-sm-8">
                                                    <form:input path="userId" cssClass="form-control" value="${user.userId}" placeholder="用户id" readonly="true"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">游客状态</label>
                                                <div class="col-sm-8">
