                    ...
                    <div class="card alert">
                                ...
                                <ul>
                                    ...
                                    <li class="card-option drop-menu"><i class="ti-settings" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" role="link"></i>
                                        <ul class="card-option-dropdown dropdown-menu">
                                            <li><a href="${pageContext.request.contextPath}/tourist/toAdd.do"><i class="ti-loop"></i> 更新日志</a></li>
                        ...
                        <div class="card-body">
                            <div class="horizontal-form-elements">
                                <form:form modelAttribute="tourist" method="post" action="${pageContext.request.contextPath}/tourist/addTourist.do" cssClass="form-horizontal">
                                    <div class="row">
                                        <div class="col-lg-12">
